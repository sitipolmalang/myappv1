defmodule Myappv1Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Myappv1Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Myappv1Web.Gettext, "errors", msg, opts)
    end
  end
